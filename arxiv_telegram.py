...
def fetch_rss(category: str) -> list[dict]:
    ...
    for item in items:
        ...
        # Aceita apenas artigos novos e cross-lists
        ...
        # Abstract: remove tags HTML e cabeçalho "Announce Type ... Abstract:"
        abstract = re.sub(r"<[^>]+>", " ", desc)
        abstract = re.sub(r".*?Abstract:", "", abstract, flags=re.DOTALL)
